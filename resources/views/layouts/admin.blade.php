...
<body class="bg-ukkom-darknavy text-gray-300 font-sans antialiased flex h-screen overflow-hidden selection:bg-ukkom-tosca selection:text-ukkom-darknavy">
    ...
    <aside class="relative w-72 bg-white/5 backdrop-blur-xl flex-col hidden md:flex shadow-2xl overflow-hidden border-r border-white/10 shrink-0">
        ...
        <div class="relative z-10 h-24 flex items-center justify-center border-b border-white/10 bg-black/20 shrink-0">
            <div class="flex items-center gap-3 font-extrabold text-2xl tracking-widest text-white">
                <img src="{{ asset('images/logo.png') }}" alt="Logo" class="w-8 h-8 object-contain drop-shadow-[0_0_10px_rgba(45,212,191,0.5)]">
                UKKOM
            </div>
        </div>
        ...
        <nav class="relative z-10 flex-1 px-5 py-8 space-y-3 overflow-y-auto">
            ...
            <a href="/admin/settings" class="flex items-center gap-3 px-4 py-3.5 rounded-xl border border-white/5 hover:border-ukkom-tosca/50 hover:bg-white/5 text-gray-400 hover:text-white transition duration-300 group shadow-inner">
                <span class="text-xl group-hover:scale-110 group-hover:rotate-45 transition duration-300">⚙️</span> 
                <span class="font-medium">Pengaturan Web</span>
            </a>
            <a href="/admin/activities" class="flex items-center gap-3 px-4 py-3.5 rounded-xl border border-white/5 hover:border-ukkom-tosca/50 hover:bg-white/5 text-gray-400 hover:text-white transition duration-300 group shadow-inner">
            ...
            <a href="/admin/archives" class="flex items-center gap-3 px-4 py-3.5 rounded-xl border border-white/5 hover:border-ukkom-tosca/50 hover:bg-white/5 text-gray-400 hover:text-white transition duration-300 group shadow-inner">
            ...
            <a href="/admin/board" class="flex items-center gap-3 px-4 py-3.5 rounded-xl border border-white/5 hover:border-ukkom-tosca/50 hover:bg-white/5 text-gray-400 hover:text-white transition duration-300 group shadow-inner">
                <span class="text-xl group-hover:scale-110 group-hover:rotate-12 transition duration-300">👨‍💼</span> 
                <span class="font-medium">Kelola Pengurus</span>
            </a>
        ...
        <div class="relative z-10 p-6 border-t border-white/10 bg-black/40 shrink-0">
    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden relative">
        ...
        <header class="relative z-10 mt-6 mx-6 md:mx-10 h-16 shrink-0 bg-white/5 backdrop-blur-xl shadow-2xl border border-white/10 rounded-2xl flex items-center justify-between px-6">
